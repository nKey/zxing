...
import zxing.maxicode.decoder.Decoder;
...
public final class MaxiCodeReader implements Reader {
   ...
   * case.
   *
   * @see zxing.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
   * @see zxing.qrcode.QRCodeReader#extractPureBits(BitMatrix)
   */
